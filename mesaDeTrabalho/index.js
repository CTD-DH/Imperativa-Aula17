...
// 2. Inicializar o construtor do Express.
const aplicativo = new express();

// 3. Criando a Rota e retornando alguma informação.
aplicativo.get('/', (requisicaoAoServidor, respostaDoServidor) => respostaDoServidor.send('Seja bem-vindo ao mesa-de-trabalho-17'));

// 4. Criando a segunda Rota.
aplicativo.get('/sobre', (requisicaoAoServidor, respostaDoServidor) => respostaDoServidor.send('Sobre o projeto'));
